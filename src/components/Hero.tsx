  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-1 h-1 bg-electric/30 rounded-full animate-float animation-delay-100" />
        <div className="absolute top-1/3 right-1/4 w-1 h-1 bg-electric/20 rounded-full animate-float animation-delay-300" />
        <div className="absolute bottom-1/4 left-1/3 w-1 h-1 bg-electric/30 rounded-full animate-float animation-delay-500" />
      </div>

      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-12">
          {/* Trust Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-electric/10 border border-electric/20 text-electric text-sm font-medium animate-fade-in-up">
          ...
          <div className="space-y-6 animate-fade-in-up animation-delay-100">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight">
              ...
              <span className="text-gradient-electric">eCommerce Automation</span>
            </h1>
          ...
          <div className="pt-16 animate-scale-in animation-delay-400">
            <div className="relative max-w-4xl mx-auto">
              {/* Subtle Glow Effect */}
              <div className="absolute inset-0 bg-electric/10 rounded-2xl blur-3xl scale-105" />
              
              {/* Dashboard Image */}
              <div className="relative bg-gradient-card rounded-2xl p-3 border border-electric/20">
                <img
                  src={dashboardHero}
                ...
                {/* Floating Metrics */}
                <div className="absolute top-8 left-8 bg-card/90 backdrop-blur-sm rounded-lg p-3 border border-electric/20">
                  <div className="text-xs text-foreground-muted">Revenue Today</div>
                  <div className="text-lg font-bold text-electric">$24,847</div>
                </div>
                
                <div className="absolute bottom-8 right-8 bg-card/90 backdrop-blur-sm rounded-lg p-3 border border-electric/20">
